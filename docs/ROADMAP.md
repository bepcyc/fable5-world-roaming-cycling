...
### M1.5.3 Рука как реальная рука + хват как реальный хват (owner-ordered 2026-07-04)
- **Почему:** M1.5.2-руки «наложены на руль», не обхватывают. Диагноз (подтверждён владельцем): (1) кисть из ~40 примитивов = «кукла Lego», потолок метода — шлифовка примитивов запрещена; (2) хват подбирался euler-углами, контакт с трубой — случайность, а не конструкция; (3) итерации судились по ride-кадрам (кисть 30–50 px), крупных планов почти не было; (4) кожа-пластик: ни контактного затемнения, ни складок, GTAO на 8-мм пальцах пуст; (5) в основе неверная анатомия: «фаланга-1 поперёк верха трубы» — на деле поперёк верха лежит ЛАДОНЬ, пальцы стартуют с передней кромки.
- **Scope:** (1) кисть ЕДИНОЙ сеткой (metaball/SDF → запечённый mesh 2–5k tris): веер пястных, гребень костяшек MCP, перепонки, тенар/гипотенар, сухожилия спинки; три позы (топы/капюшоны/грипсы) СНЯТЫЕ С ФОТО владельца (`shots/wip/what_i_want/`); (2) хват параметризацией ОТ ЦИЛИНДРА (центр/ось/радиус трубы+плоти → фаланги на спирали по построению, контакт гарантирован); (3) расплющивание плоти в полосе контакта; (4) контактная тень на трубе под ладонью/пальцами + затемнение сгибов в материале; (5) анатомия хвата: труба поперёк ладони (бугор указательного → бугор мизинца), ладонь давит сверху-сзади, проксимальные фаланги вниз по ПЕРЕДНЕЙ стороне, кончики в замок к бугру большого, с ракурса райдера видны только спинка/костяшки/1–2 фаланги.
- **Acceptance:** крупный план каждой позы против КРОПА руки референса (кисть в сотни пикселей) + полные side-by-side всех трёх велов; вердикт владельца «принято». **ЖЕЛЕЗНОЕ ПРАВИЛО (CLAUDE.md №2): каждая итерация = sbs всех трёх велов в бот, без исключений; пропуск = мгновенная остановка всех процессов.**
- **Depends on:** M1.5.2 (кокпит-каркас). **Sessions:** 1–2. **Top risk:** процедурный скульпт кисти в один mesh — новая техника для кодовой базы; fallback: metaball-поле из капсул с общей SDF-оболочкой (marching cubes уже есть в three/addons).
